...
def test_infer(folder):
    ...
    try:
        response.raise_for_status() # raise http request failure
    ...
    try:
        ...
        print("Inference Test:", response_json)
        return response_json['prediction'], response_json['is_ood']
    except ValueError:
        print("Errore nella risposta JSON:", response.text)
        return None
